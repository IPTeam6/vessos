...
#logo.night {background-image: url(http://fireandrescue.webelevate.net/img/logo_white.svg); transition: 1s;}
#logo.day {background-image: url(http://fireandrescue.webelevate.net/img/logo_black.svg); transition: 1s;}
...
.bell.night {background:url(http://fireandrescue.webelevate.net/img/request_assistance_icon.svg); transition: 1s;}
.bell.day {background:url(http://fireandrescue.webelevate.net/img/request_assistance_icon_black.svg); transition: 1s;}
